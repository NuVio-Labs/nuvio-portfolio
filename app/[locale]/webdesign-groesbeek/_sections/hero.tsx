...
export async function Hero() {
    const t = await getTranslations("webdesignGroesbeek.hero")

    return (
        <section className="relative overflow-hidden bg-background pb-16 pt-28 text-text-primary md:pb-20 md:pt-32">
            <div className="pointer-events-none absolute inset-0">
                <div className="absolute right-[-10rem] top-[10%] h-[24rem] w-[24rem] rounded-full bg-accent/10 blur-[140px]" />
            ...
            <div className="nv-container relative z-10">
                <div className="mx-auto max-w-[760px] text-center">
                    ...
                    <p className="mt-6 text-sm text-text-muted">{t("crossBorderNote")}</p>
                </div>
            </div>
        </section>
    )
