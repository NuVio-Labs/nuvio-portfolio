 ...
 * die faq-accordion.tsx der Kranenburg-/Kleve-Routen, mit eigenen Inhalten.
 * Bewusst lokal dupliziert statt aus einer anderen Local-SEO-Route
 * importiert, damit die Seiten unabhaengig voneinander bleiben.
 */
    ...
    return (
        <div className="space-y-3">
            {items.map((item, index) => {
                ...
                const panelId = `webdesign-groesbeek-faq-panel-${index}`
