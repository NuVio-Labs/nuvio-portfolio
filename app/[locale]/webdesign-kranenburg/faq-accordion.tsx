...
/**
 * Eigenstaendige Variante von components/sections/faq.tsx: gleiches
 * Interaktions- und Visualmuster, aber mit Inhalten als Props statt
 * fest verdrahteter Namespace-Keys, da diese Seite eigene FAQ-Inhalte hat.
 */
    ...
    return (
        <div className="space-y-3">
            {items.map((item, index) => {
                ...
                const panelId = `webdesign-kranenburg-faq-panel-${index}`
