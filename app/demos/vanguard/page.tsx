...
export default function VanguardDemoPage() {
            ...
            <Container>
                <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <h1 className="text-3xl font-bold tracking-tight">Vanguard Demo</h1>
                        <p className="text-muted-foreground mt-1">
                            A local interactive demo of the trading dashboard interface.
                        </p>
                    </div>
                ...
                <div className="h-[600px] w-full rounded-xl overflow-hidden border bg-background shadow-xl">
                    <VanguardDemo key={key} mode="full" />
                </div>
            </Container>
        </main>
    )
